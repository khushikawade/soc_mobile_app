...
class DayView<T extends Object?> extends StatefulWidget {
  ...
  Future<void> Function() pullToRefresh;
  DayView(
      {Key? key,
...
class DayViewState<T extends Object?> extends State<DayView<T>> {
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (_, index) {
                            ...
                            return InternalDayViewPage<T>(
                              ...
                              eventTileBuilder:
                                  _eventTileBuilder, // _eventTileBuilder,
  ...
  Widget _defaultEventTileBuilder(
    ...
    var strDate = "${events[0].startTime}";
    final stringFormat = dateFormat.format(DateTime.parse(strDate));
    var endDate = "${events[0].endTime}";
    final enddATE = dateFormat.format(DateTime.parse(endDate));
    //comehereagain
    ...
    if (events.isNotEmpty)
      return RoundedEventTile(
        ...
        padding: EdgeInsets.fromLTRB(5.0, 2, 2, 2),
