...
class StudentPlusCourseWorkModel {
    ...
    factory StudentPlusCourseWorkModel.fromRawJson(String str) => StudentPlusCourseWorkModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory StudentPlusCourseWorkModel.fromJson(Map<String, dynamic> json) => StudentPlusCourseWorkModel(
        ...
        studentWorkSubmission: json["studentWorkSubmission"] == null ? [] : List<StudentWorkSubmission>.from(json["studentWorkSubmission"]!.map((x) => StudentWorkSubmission.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "studentWorkSubmission": studentWorkSubmission == null ? [] : List<dynamic>.from(studentWorkSubmission!.map((x) => x.toJson())),
    };
}
...
class StudentWorkSubmission {
    ...
    factory StudentWorkSubmission.fromRawJson(String str) => StudentWorkSubmission.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory StudentWorkSubmission.fromJson(Map<String, dynamic> json) => StudentWorkSubmission(
        courseId: json["courseId"],
        ...
        assignmentSubmission: json["assignmentSubmission"] == null ? null : AssignmentSubmission.fromJson(json["assignmentSubmission"]),
        associatedWithDeveloper: json["associatedWithDeveloper"],
    );
...
class AssignmentSubmission {
    ...
    factory AssignmentSubmission.fromRawJson(String str) => AssignmentSubmission.fromJson(json.decode(str));
