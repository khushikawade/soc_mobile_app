...
//   CustomHomePage({Key? key, this.title, this.homeObj, this.language, this.builder})
//       : super(key: key);
...
// class _CustomHomePageState extends State<CustomHomePage> with WidgetsBindingObserver {
...
//       Widget _tabBarBody1() => PersistentTabView(
//         context,
...
//       body: Stack(
//         children: [
//           Globals.ischange ?_tabBarBody1():_tabBarBody(),
