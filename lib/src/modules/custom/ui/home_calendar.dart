...
//     with AutomaticKeepAliveClientMixin<HomeCalendar> {
//   static const double _kLabelSpacing = 15.0;
//   CustomBloc _calendarBloc = CustomBloc();
...
//     _calendarBloc.add(CalendarListEvent(calendarId: widget.calendarId));
...
//                 _calendarBloc
//                     .add(CalendarListEvent(calendarId: widget.calendarId));
//                 iserrorstate = false;
//               }
//             } else if (!connected) {
//               iserrorstate = true;
