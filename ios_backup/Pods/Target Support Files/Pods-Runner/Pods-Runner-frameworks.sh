...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/open_apps_settings/open_apps_settings.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/speech_bubble/speech_bubble.framework"
