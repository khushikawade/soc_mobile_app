...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.creativemind.open_apps_settings.OpenAppsSettingsPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin open_apps_settings, com.creativemind.open_apps_settings.OpenAppsSettingsPlugin", e);
    }
    try {
    ...
    try {
      ...
      Log.e(TAG, "Error registering plugin speech_bubble, com.plushundred.speechbubble.SpeechBubblePlugin", e);
    }
    try {
